    ...
    public partial class Login : Form
    {
        ...
        private void BtLogin_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (nv.ChucVu.TenChucVu == "QUẢN LÝ" && nv.TaiKhoan.PassWord.Trim() == DataProvider.Instance.EncodePass(tbPassword.Text))
                    {
                        Dashboard ds = new Dashboard();
                        ds.loadInforNV(nv);
                    ...
                    else if (nv.ChucVu.TenChucVu == "BÁN HÀNG" && nv.TaiKhoan.PassWord.Trim() == DataProvider.Instance.EncodePass(tbPassword.Text))
                    {
       ...
       private void TB_Enter_Keydown(object o,KeyEventArgs e)
        ...
        private void btDoiMatKhau_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = "update TaiKhoan set PassWord = '" + DataProvider.Instance.EncodePass(tbXacNhanPass.Text)
